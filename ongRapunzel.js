...
export default function ongCabelegria() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image source={require('./img/imgRapunzelSolidaria.png')} style={styles.headerImage} />
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Rapunzel Solidária</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={{ flex: 1, alignItems: 'flex-end' }}>
            <Text style={styles.cardText}>55% das solicitações atendidas</Text>
        ...
        A ONG Rapunzel Solidária transforma doações de cabelo em perucas para pessoas em tratamento contra o câncer. Seu trabalho resgata a autoestima e leva esperança a quem enfrenta desafios de saúde.
        </Text>
