...
export default function ongCabelegria() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image source={require('./img/imgOncoamigo.png')} style={styles.headerImage} />
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Oncoamigo</Text>
        <Text style={styles.address}>Av. Emílio Ribas, 613</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={{ flex: 1, alignItems: 'flex-end' }}>
            <Text style={styles.cardText}>72% das solicitações atendidas</Text>
        ...
        A ONG Oncoamigo oferece suporte emocional, social e material a pacientes oncológicos e seus familiares. Com ações solidárias, busca tornar o tratamento mais leve e acolhedor.
        </Text>
...
const styles = StyleSheet.create({
  ...
  cardSub: {
    fontSize: 10, // Ajuste do tamanho do texto
    color: 'gray',
  },
  progressBar: {
    width: '100%', // <- ESSENCIAL para a barra funcionar
    height: 6,
    backgroundColor: '#eee',
    borderRadius: 3,
    marginTop: 8,
